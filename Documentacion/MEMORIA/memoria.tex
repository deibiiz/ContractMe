...
Este proyecto se enfoca en la creación de una solución innovadora para la contratación laboral, aprovechando la tecnología blockchain y los contratos inteligentes. Se busca agilizar el proceso de contratación en sectores como la agricultura y servicios domésticos mediante la automatización de la gestión de contratos desde su inició hasta su final.
La solución propuesta incluye funcionalidades avanzadas como el seguimiento del tiempo de trabajo y el pago automático, integrando tecnologías de localización GPS para establecer zonas de trabajo específicas.
