...
\imagen{DTL}{Proceso de actualización del libro mayor}{.6}
...
\imagen{enlaceBloques}{Encadenamiento de bloques en la Blockchain}{.6}
...
\imagen{firmaDigital}{Transacción encriptada con con firma digital}{.6}
